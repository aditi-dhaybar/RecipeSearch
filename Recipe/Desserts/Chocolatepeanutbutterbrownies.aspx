<%@ Page Title="" Language="C#" MasterPageFile="~/Recipe.master" AutoEventWireup="true" CodeFile="Chocolatepeanutbutterbrownies.aspx.cs" Inherits="ItemDetail_ItemDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="RecipeBody" Runat="Server">
        ...
        <aside class="asideitem">
            <div class="item-header">
                <h1 style="margin-left:30px;">Chocolate<br />Brownie<br /></h1>
                 <img src="../../Images/Dessert3.jpg" style="height:250px; width:325px; margin-left: 40px;"/>  
                 <img src="../../Images/cbb2.jpg" style="height:250px; width:380px;"/>  
                 <img src="../../Images/cbb3.jpg" style="height:250px; width:270px;"/>  
            </div>
            <div class="item-description">Yummy, delicious brownies, which one should never miss! </div>
            <div class="facts">
                <ul>
