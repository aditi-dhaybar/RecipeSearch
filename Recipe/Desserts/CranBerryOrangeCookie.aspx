<%@ Page Title="" Language="C#" MasterPageFile="~/Recipe.master" AutoEventWireup="true" CodeFile="CranBerryOrangeCookie.aspx.cs" Inherits="ItemDetail_ItemDetail" %>
        ...
        <aside class="asideitem">
            <div class="item-header">
                <h1 style="margin-left:30px;">Cranberry<br />Orange<br />Cookies</h1>
                 <img src="../../Images/Dessert4.jpg" style="height:250px; width:325px; margin-left: 40px;"/>  
            ...
            <div class="other-items">
               ...
               <div style="display :flex ;flex-direction :column;width:300px; margin-left :26px;">  <p><img src="../../Images/Dessert2.jpg" style="height:210px; width:300px;"/><span style="font-weight:bold; font-size:20px;"><a href="ChocolateLayeredVanillapuddingpie.aspx">Layered Vanilla Pudding</a></span></p></div> 
