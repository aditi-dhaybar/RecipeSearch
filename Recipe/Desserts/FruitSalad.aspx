<%@ Page Title="" Language="C#" MasterPageFile="~/Recipe.master" AutoEventWireup="true" CodeFile="FruitSalad.aspx.cs" Inherits="ItemDetail_ItemDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="RecipeBody" Runat="Server">
        ...
        <aside class="asideitem">
            <div class="item-header">
                <h1 style="margin-left:30px;">Fruit<br />Salad<br />Parfaits</h1>
                 <img src="../../Images/Dessert5.jpg" style="height:250px; width:325px; margin-left: 40px;"/>  
                 <img src="../../Images/fs2.jpg" style="height:250px; width:380px;"/>  
                 <img src="../../Images/fs3.jpg" style="height:250px; width:270px;"/>  
            </div>
            <div class="item-description">With a bold and zesty finish, 
                    this blend spices up any snack, 
                    salad or meal! Try layering with fresh fruit and drizzle with Poppy Seed Dressing </div>
            <div class="facts">
                <ul>
            ...
            <div class="ingredients">
                ...
                <ul style="font-size:18px;">
                    <li><span style="color: red; font-weight: bold;">1 cup </span>Chocolate Powder</li>
           ...
           <div style="display :flex ;flex-direction :column;width:300px; margin-left :26px;">      <p><img src="../../Images/Dessert1.jpg" style="height:210px; width:300px; "/><span style="font-weight:bold; font-size:20px;"><a href="blueberrycrisp.aspx">BlueBerry Crisp</a></span></p></div> 
